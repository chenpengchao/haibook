...
import com.hyjz.hnovel.bean.ReadTheme;
...
public class ThemeManager {
    ...
    public static Bitmap getThemeDrawable(int theme) {
        ...
        switch (theme) {
            case NORMAL:
                bmp.eraseColor(ContextCompat.getColor(MyApp.getInstance(), R.color.read_theme_white));
                break;
            case YELLOW:
                bmp.eraseColor(ContextCompat.getColor(MyApp.getInstance(), R.color.read_theme_yellow));
                break;
            case GREEN:
                bmp.eraseColor(ContextCompat.getColor(MyApp.getInstance(), R.color.read_theme_green));
                break;
            case LEATHER:
                bmp = BitmapFactory.decodeResource(MyApp.getInstance().getResources(), R.drawable.theme_leather_bg);
                break;
            case GRAY:
                bmp.eraseColor(ContextCompat.getColor(MyApp.getInstance(), R.color.read_theme_gray));
                break;
            case NIGHT:
                bmp.eraseColor(ContextCompat.getColor(MyApp.getInstance(), R.color.read_theme_night));
                break;
            default:
                break;
        }
