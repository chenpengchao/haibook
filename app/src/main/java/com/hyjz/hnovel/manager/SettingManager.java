...
//    }
//
//    public int getReadFontSize(Long bookId) {
...
//    }
//
//    private String getFontSizeKey(Long bookId) {
...
//    }
//
//    public synchronized void saveReadProgress(Long bookId, int currentChapter, int m_mbBufBeginPos, int m_mbBufEndPos) {
...
//     * @return
//     */
//    public int[] getReadProgress(Long bookId) {
...
//    }
//
//    public void removeReadProgress(Long bookId) {
//        SharedPreferencesUtil.getInstance()
...
//    }
//
//    private String getChapterKey(Long bookId) {
//        return bookId + "-chapter";
//    }
//
//    private String getStartPosKey(Long bookId) {
//        return bookId + "-startPos";
//    }
//
//    private String getEndPosKey(Long bookId) {
