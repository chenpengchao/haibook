...
public class ScreenUtils {
    ...
    public static float dpToPx(float dp) {
        return dp * MyApp.getInstance().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / MyApp.getInstance().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * MyApp.getInstance().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static int getScreenBrightnessInt255() {
        ...
        try {
            screenBrightness = Settings.System.getInt(MyApp.getInstance().getContentResolver(), Settings.System.SCREEN_BRIGHTNESS);
        } catch (Exception e) {
            e.printStackTrace();
        }
