...
public class Constant {
    ...
    public static String PATH_DATA = FileUtils.createRootPath(MyApp.getInstance()) + "/cache";

    public static String PATH_COLLECT = FileUtils.createRootPath(MyApp.getInstance()) + "/collect";
    ...
    public static String BASE_PATH = MyApp.getInstance().getCacheDir().getPath();
