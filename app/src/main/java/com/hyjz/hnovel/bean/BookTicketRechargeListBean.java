...
public class BookTicketRechargeListBean {
    ...
    private List<BookTicketRechargeBean> list = new ArrayList<>();
    ...
    public List<BookTicketRechargeBean> getList() {
        return list;
    }

    public void setList(List<BookTicketRechargeBean> list) {
        this.list = list;
    }
